...
<div class="l-page">
  <iframe src="{{ '/plots/radar_importance.html' | relative_url }}" frameborder='0' scrolling='no' height="600px" width="130%" style="border: 0px dashed grey;display: flex; justify-content: center; align-items: center;"></iframe>
</div>
...
<div class="l-page">
  <iframe src="{{ '/plots/mean_countries.html' | relative_url }}" frameborder='0' scrolling='no' height="600px" width="100%"></iframe>
</div>
